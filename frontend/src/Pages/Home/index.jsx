      ...
      <div className="homepage">
        ...
        <section className="news">
          ...
          <div className="news-item">
            ...
            <p>
              We are pleased to share our financial results for the first
              quarter. Our company has seen a 20% increase in revenue compared
              to last year.
            </p>
          </div>
          <div className="news-item">
            ...
            <p>
              Join us for our annual company retreat in June. It's a great
              opportunity to connect with colleagues and engage in team-building
              activities.
            </p>
          </div>
        </section>
